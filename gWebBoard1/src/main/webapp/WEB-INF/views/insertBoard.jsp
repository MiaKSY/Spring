		...
		<form action="saveBoard.do" method='post' enctype="multipart/form-data"> 
			<table border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<input type="hidden" name="b_ip" value="<%=request.getRemoteAddr()%>"> <!-- 아이피!! -->
					</td>
				</tr>
				<tr>
					<td bgcolor="orange" width="70">파일추가</td><td align="left">
					<input type="file" maxlength="60" size="40" name="file"></td> <!-- 파일보내는 이름은 무조건 file -->
				</tr>
				<!-- 추가항목 끝 -->
				<tr>
